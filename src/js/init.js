...
export default function () {
  ...
  const ca = new ChromaticAberrationEffect({
    offset: new Vector2(
      Config.postprocessing.CAoffset,
      Config.postprocessing.CAoffset
    ),
  });

  const vignette = new VignetteEffect({
    darkness: Config.postprocessing.darkness,
  });
  const bloom = new BloomEffect({
    luminanceThreshold: Config.postprocessing.luminanceThreshold,
    luminanceSmoothing: Config.postprocessing.luminanceSmoothing,
  });
